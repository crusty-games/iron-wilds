// for experiments -- this code is copied directly from one of the noise.rs examples
...
pub fn gen_planet() -> NoiseMap {
    /// Planet seed. Change this to generate a different planet.
    const CURRENT_SEED: u32 = 23243;
